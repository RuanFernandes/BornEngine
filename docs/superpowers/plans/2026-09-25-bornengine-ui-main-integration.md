...
- [ ] Commit the isolated UI implementation and rebase it onto `origin/main`.
- [ ] Resolve API, navigation, and documentation overlaps while retaining both
  the Game API and the UI APIs.
- [ ] Add website documentation for production UI and developer debug UI.
- [ ] Bump the npm package version for this additive API release.
- [ ] Run native, TypeScript/Perry, FFI, and website checks; review the diff.
